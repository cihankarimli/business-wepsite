...
function Navbar() {
  ...
  const desktopButtonstyle =
    "hidden lg:block margin border-2 bg-[#CE7D63] border-[#CE7D63] hover:border-orange-100 px-6 py-2 rounded-md text-gray-50 hover:text-orange-100 transition-colors cursor-pointer";
  return (
